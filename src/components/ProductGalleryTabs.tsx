...
// 1. Define allowed tab names
type TabName = 'Apparel' | 'Bags' | 'Accessories' | 'Furniture';
...
const tabData: Record<TabName, TabItem> = {
  Apparel: {
...
const ProductGalleryTabs = () => {
  // 4. Type activeTab correctly
  const [activeTab, setActiveTab] = useState<TabName>('Bags');
  const [isTransitioning, setIsTransitioning] = useState(false);

  const currentData = tabData[activeTab]; // ✅ Now type-safe!
      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 md:gap-10 items-start">
          ...
          <div className="text-center lg:text-left">
            ...
            <div
              className={`relative overflow-hidden rounded-xl aspect-[4/5] md:aspect-[3/4] transition-opacity duration-400 ${
          ...
          <div className="text-center lg:text-left">
            <div
              className={`relative overflow-hidden rounded-xl aspect-[4/5] md:aspect-[3/4] mb-4 md:mb-6 transition-opacity duration-400 ${
                isTransitioning ? 'opacity-0' : 'opacity-100'
              }`}
            >
              <img
          ...
          <div className="text-center lg:text-left">
            ...
            <div
              className={`relative overflow-hidden rounded-xl aspect-[4/5] md:aspect-[3/4] group transition-opacity duration-400 ${
                isTransitioning ? 'opacity-0' : 'opacity-100'
              }`}
            >
              <video
