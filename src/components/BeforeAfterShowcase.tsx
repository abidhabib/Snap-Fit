...
return (
  <div className="group flex-shrink-0 w-[180px] md:w-[200px] flex flex-col items-center">
    ...
    <div 
    className="transition-all duration-300 border border-purple-100/40 hover:border-purple-200/60 w-full">
      {/* Before/After Slider Container */}
      <div className=" rounded-xl overflow-hidden shadow-sm hover:shadow-lg ">
        <div
          ref={containerRef}
          className="relative w-full aspect-[3/4] cursor-ew-resize" // Reduced aspect ratio → smaller height
          onMouseDown={handleMouseDown}
          onTouchStart={handleTouchStart}
        >
          {/* Dark overlay for better contrast on light images */}
          ...
          {/* Label + Glass Button - Bottom Left */}
          <div className="absolute bottom-2 left-2 z-30 flex flex-col items-start space-y-1">
            ...
            <button
              className="px-2 py-1 text-[10px] font-medium text-gray-600 rounded-full 
      ...
      <div className="max-w-full">
        <div className="text-center mb-12">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            See the{' '}
            <span className="text-4xl md:text-5xl font-bold text-gray-900 mb-4 bg-gradient-to-r from-slate-600 to-lime-600 bg-clip-text text-transparent  mb-6">
              SnapFit Difference
            </span>
          </h2>
        ...
        {/* Horizontal Scroll Container - Centered */}
      <div className="flex justify-center gap-4 md:gap-6 overflow-x-auto scrollbar-hide p-16 bg-gradient-to-br from-purple-100/60 to-purple-100/40 rounded-2xl">
